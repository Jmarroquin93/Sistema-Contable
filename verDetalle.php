...
<div class="card-header"> Descripcion: <b>'.$descripcion.' </b> </div>
...
<tr><td><b>CUENTA</td><td><b>CARGO</td><td><b>ABONO</td></tr></thead><tbody>';
...
$sql="call Get_detalle_partida(".$id.");";
...
echo"<tr><td><b>Totales</td><td><b>$ ".$total."</td><td><b>$ ".$total."</td></tr>";
echo"</tbody></table>";
}
