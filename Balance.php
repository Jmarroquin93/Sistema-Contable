...
<div class="card-header"><p align='center'><b>Balance Inicial</b></p></div>
<div class="card-body">
<div class="row no-gutters">
<div class="col-12 pull-left">
  <p align='center'><b>Activos</b></p>
...
if($conn){
$totalPasivos=0;
$sql="call Get_Fecha_Inicial('".$usuario."');";
...
echo"<tr><td><b></td><td><b></td><td><b></td><td><b></td><td><b>Total Capital</td><td><b></td><td><b>$ ".$totalCapital."</td></tr>";
echo"<tr><td><b></td><td><b></td><td><b></td><td><b></td><td><b>Total Pasivo + Capital</td><td><b></td><td><b>$ ".($totalCapital+$totalPasivos)."</td></tr>";

echo"</tbody></table>";
echo '<div class="row" > <a href="ReporteBalanceInicialPdf.php?usuario='.$usuario.'&fechaFinal='.$FechaFin.'" class="btn btn-success btn-block" type=submit><span class="fa-stack fa-lg"><i class="fa fa-arrow-circle-down fa-stack-2x" aria-hidden="true"></i></span> PDF </a></div>';
