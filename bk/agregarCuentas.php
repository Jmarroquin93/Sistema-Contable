...
$sql="call Get_Cuentas_2_Digitos();";
...
echo"<tr><td><b>$row[0]</td><td><b>$row[1]</td><td><b>$row[2]</td><td><b><button type='button' class='btn btn-success' onclick=add_2_cuentasModal($row[0],'$row[1]','$row[2]')>AGREGAR</button></td><td><b><a href=agregarCuentas4.php?usuario=".$usuario."&correlativo=$row[0]&nombre=$row[1]&$row[2] class='btn btn-warning'>SUB CUENTAS</a></td></tr>";
} 
echo"</tbody></table>";
}
