       ...
       <div class="form-group">
            <label for="recipient-name" class="col-form-label">Cuenta</label>
             <select class="form-control js-example-basic-single" id="txtCuenta">
              <option>Bautismos</option>
              <option>Primeras Comuniones</option>
              <option>15 años</option>
              <option>Expediente Matrimonial</option>
              <option>Matrimonios</option>
              <option>Exequias</option>
              <option>Misas fuera de horario</option>
              <option>Dia de difuntos</option>
...
<button  onclick="Guardar()" class="btn btn-success btn-block"><span class="fa-stack fa-lg">
 ...
 setTimeout(function(){
    ...
    $.ajax({
   type: "POST",
     url: "server.php?p=agregar_detalle_partida_especial",
