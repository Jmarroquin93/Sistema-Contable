...
<div class="card-header">Detalle Partidas</div>
<div class="card-body">
<label id="lblmsg"></label>

<table class="table" id="mitablaiglesia" width='100%'><thead>
<tr><td><b>DESCRIPCION</td><td><b>FECHA</td><td><b>TOTAL</td><td><b>DETALLE</td></tr></thead><tbody>
<?php
...
echo"<tr><td><b>$row[1]</td><td><b>$row[2]</td><td><b>$row[3]</td><td><b><a href=verDetalle.php?usuario=".$usuario."&id=$row[0]&total=$row[3]&descripcion=".urlencode($row[1])." class='btn btn-warning btn-block'>DETALLE</a></td></tr>";
} 
echo"</tbody></table>";
}
