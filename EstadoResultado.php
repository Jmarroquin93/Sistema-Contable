...
<div class="card-header">Buscar Fechas de Estado de Resultados</div>
<div class="card-body">
<form method=post action=EstadoResultado.php>
  <div class="row">
...
<div class="col-12 col-md-12">
<div class="card card-info">
<div class="card-header"><p align='center'><b>Estado de Resultado <?php if($_POST){$FechaFin=$_POST['txtFechaFin']; $FechaInicio=$_POST['txtFechaInicio'];echo ' del '.$FechaInicio.' al '.$FechaFin ;} ?> </b></p></div>
<div class="card-body">
<div class="row no-gutters">
<div class="col-12 pull-left">
  <p align='center'><b>GASTOS</b></p>
...
echo"<tr><td><b></td><td><b></td><td><b></td><td><b></td><td><b>Total</td><td><b></td><td><b>$ ".$totalActivos."</td></tr>";
...
echo"<tr><td><b></td><td><b></td><td><b></td><td><b></td><td class='bordito-b'><b>Total</td><td class='bordito-b'><b></td><td class='bordito-b'><b>$ ".$totalPasivos."</td></tr>";
...
if($Superavit>0){
echo"<tr><td><b></td><td><b></td><td><b></td><td><b></td><td class='bordito-b'><b>Superavit del periodo</td><td class='bordito-b'><b></td><td class='bordito-b'><b>$ ".$Superavit."</td></tr>";
}else{
 echo"<tr><td><b></td><td><b></td><td><b></td><td><b></td><td class='bordito-b'><b>Deficit del periodo</td><td class='bordito-b'><b></td><td class='bordito-b'><b>$ ".$Superavit."</td></tr>";
 
}
echo"</tbody></table>";
echo '<div class="row" > <a href="ReporteBalance.php?usuario='.$usuario.'&fechaFinal='.$FechaFin.'&superavit='.$Superavit.'" class="btn btn-success btn-block" type=submit><span class="fa-stack fa-lg">
 <i class="fa fa-calculator fa-stack-2x" aria-hidden="true"></i>
</span> Ver Balance</a></div><br>';

echo '<div class="row" > <a href="ReporteEstado.php?usuario='.$usuario.'&fechaInicial='.$FechaInicio.'&fechaFinal='.$FechaFin.'&superavit='.$Superavit.'" class="btn btn-success btn-block" type=submit><span class="fa-stack fa-lg">
