...
$sql="call Get_Cuentas_6_Digitos('".$usuario."','".$correlativo."');";
...
echo"<tr><td><b>$row[0]</td><td><b>$row[2]</td><td><b>$row[1]</td><td><b><a href=agregarCuentas8.php?usuario=".$usuario."&correlativo=$row[0]&tipo=$row[2]&nombre=".urlencode($row[1])." class='btn btn-warning'>SUB CUENTAS</a></td><td><button type='button' class='btn btn-danger' onclick='retroactiva(\"$row[1]\")'>ACTUALIZAR</button></td></tr>";
} 
echo"</tbody></table>";
}
