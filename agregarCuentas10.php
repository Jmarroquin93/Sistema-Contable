...
<tr><td><b>CORRELATIVO</td><td><b>TIPO CUENTA</td><td><b>NOMBRE</td><td><b>RETROACTIVA</td></tr></thead><tbody>';
...
$sql="call Get_Cuentas_10_Digitos('".$usuario."','".$correlativo."');";
...
echo"<tr><td><b>$row[0]</td><td><b>$row[2]</td><td><b>$row[1]</td><td><button type='button' class='btn btn-danger' onclick='retroactiva(\"$row[1]\")'>ACTUALIZAR</button></td></tr>";
} 
echo"</tbody></table>";
}
